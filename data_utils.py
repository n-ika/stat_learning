...
def get_syll_vec(model_type,root_raw_stims,exp):
    if exp==1:
    ...
    if model_type=='onehot':
        ...
        syll_vec=get_acoustic_new_vecs(root_raw_stims,sylls)
    return(syll_vec)
...
def get_phon_vecs(sylls,stims_file=None):
    if stims_file is None:
        stims_file = '/Users/nika/Desktop/hippocampus/stat_learning/zevin/zevin_data/language_simulations/mapping.txt'
...
def get_acoustic_new_vecs(root_stims,sylls_ex):
    n_fft=512
    n_mels=16
    tgt_sr = 16000
    syll_vec = {}
